...
export class World {
    ...
    add_collider_aabb(id, hx, hy, hz) {
        wasm.world_add_collider_aabb(this.__wbg_ptr, id, hx, hy, hz);
    }
    /**
    ...
    add_material(entity_id, texture_id) {
        wasm.world_add_material(this.__wbg_ptr, entity_id, texture_id);
    }
    /**
    ...
    add_mesh_renderer(id) {
        wasm.world_add_mesh_renderer(this.__wbg_ptr, id);
    }
    /**
     * Associe un matériau PBR complet à l'entité.
     * @param {number} entity_id
     * @param {number} albedo_tex
     * @param {number} metallic
     * @param {number} roughness
     */
    add_pbr_material(entity_id, albedo_tex, metallic, roughness) {
        wasm.world_add_pbr_material(this.__wbg_ptr, entity_id, albedo_tex, metallic, roughness);
    }
    /**
    ...
    add_point_light(id, r, g, b, intensity) {
        wasm.world_add_point_light(this.__wbg_ptr, id, r, g, b, intensity);
    }
    /**
    ...
    add_rigid_body(id, is_static) {
        wasm.world_add_rigid_body(this.__wbg_ptr, id, is_static);
    }
    /**
     ...
     */
    create_entity() {
        const ret = wasm.world_create_entity(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    load_scene(json) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.world_load_scene(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     ...
     */
    static new(canvas) {
        const ret = wasm.world_new(canvas);
        return ret;
    }
    /**
     ...
     * @param {number} texture_id
     */
    register_texture(name, texture_id) {
    ...
    save_scene() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.world_save_scene(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set_persistent(id, persistent) {
        wasm.world_set_persistent(this.__wbg_ptr, id, persistent);
    }
    /**
     ...
     */
    set_player(id) {
        wasm.world_set_player(this.__wbg_ptr, id);
    }
    /**
     * @param {number} id
     * @param {number} x
    ...
    set_rotation(id, x, y, z) {
        wasm.world_set_rotation(this.__wbg_ptr, id, x, y, z);
    }
    /**
     * @param {number} id
     * @param {number} x
     ...
     * @param {boolean} generate_mipmaps
     * @returns {number}
     */
    upload_texture(width, height, data, generate_mipmaps) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.world_upload_texture(this.__wbg_ptr, width, height, ptr0, len0, generate_mipmaps);
        return ret >>> 0;
    }
}
        ...
        __wbg_new_b5d9e2fb389fef91: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h564448fd7b5a9a51(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
...
function wasm_bindgen__convert__closures_____invoke__hb5a70b2dabc2cd9f(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__hb5a70b2dabc2cd9f(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h564448fd7b5a9a51(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h564448fd7b5a9a51(arg0, arg1, arg2, arg3);
}
